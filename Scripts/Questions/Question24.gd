...
func _ready():
	...
	[question,2],["Awful ending, none of this makes sense. Who even am I. Who is this speaking? Talking to a bloodly monkey! Anyway that's it! Thanks for getting this far!",3]]