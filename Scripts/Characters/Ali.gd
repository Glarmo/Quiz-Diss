...
func _ready():
	...
	["These questions take the form of block coding. This means that you will be fitting in blocks of code into the right slots and then checking if the answer is correct. To move the blocks simply click on them and then click again over a slot to drop it in! In the top left is a help box, if you're struggling with the question click it for another description of the question and hints on what to do",3],
