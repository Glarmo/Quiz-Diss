...
func _ready():
	...
	["You'll need to complete a puzzle before moving on to Maru. In this puzzle you'll need to determine the output of a function that uses the zip function. Good luck!",7]]