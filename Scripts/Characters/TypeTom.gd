...
func _ready():
	...
	["When we want to represent numbers with decimal parts like 4.5 or -70.9 we can use either a float or a double. These only differ in how precise they are. Rule of thumb: A double has double the precision on a float",2],
